...
export const CREATE_TODOLIST_FORM = 'CREATE_TODOLIST_FORM';
...
export const TASKS_CREATED_SUCCESSFULLY = 'TASKS_CREATED_SUCCESSFULLY';
export const TODO_CREATED_SUCCESSFULLY = 'TODO_CREATED_SUCCESSFULLY';
