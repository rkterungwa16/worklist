...
export const GET_TODO_ITEM_ID = 'GET_TODO_ITEM_ID';
export const CREATE_TODO = 'CREATE_TODO';
export const SET_AUTH = 'SET_AUTH';
export const UPDATE_TODO = 'UPDATE_TODO';
export const SENDING_REQUEST = 'SENDING_REQUEST';
export const SET_SIGNUP_ERROR = 'SET_SIGNUP_ERROR';
export const SET_TASK_FORM_ERROR = 'SET_TASK_FORM_ERROR';
export const SET_TODO_FORM_ERROR = 'SET_TODO_FORM_ERROR';
...
export const COMPLETE_TASK_UPDATE = 'COMPLETE_TASK_UPDATE';
...
export const TASK_CREATION_AND_DUE_DATE = 'TASK_CREATION_AND_DUE_DATE';
